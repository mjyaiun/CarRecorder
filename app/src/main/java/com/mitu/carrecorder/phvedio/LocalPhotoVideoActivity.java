 ...
 */
public class LocalPhotoVideoActivity extends FragmentActivity implements OnClickListener, OnCheckedChangeListener {

    private ImageView ivBack, toolbarEdit;
    ...
    private TextView tvTitle, tvDelete, tvShare, toolbarCancel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_local_photo_video);
        //
    ...
    public class innerFragmentPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    fragment = new FragmentLocalPhoto();
                    break;
                case 1:
                    fragment = new FragmentLocalVideo();
                    break;
            }
            return fragment;
        }
    ...
    public static interface OnMyBtnClickListener
    {
                ...
                .setShareboardclickCallback(new ShareBoardlistener() {
                    ...
                    public void onclick(SnsPlatform snsPlatform, SHARE_MEDIA share_media) {
                        if (snsPlatform.mShowWord.equals("umeng_sharebutton_custom")){
                            Toast.makeText(LocalPhotoVideoActivity.this,"自定义按钮",Toast.LENGTH_LONG).show();
                        }else {
                            new ShareAction(LocalPhotoVideoActivity.this).withText("来自友盟自定义分享面板")
    ...
    private UMShareListener umShareListener = new UMShareListener() {
        ...
        public void onResult(SHARE_MEDIA platform) {
            ...
            if(platform.name().equals("WEIXIN_FAVORITE")){
                Toast.makeText(LocalPhotoVideoActivity.this,platform + " 收藏成功啦",Toast.LENGTH_SHORT).show();
            }else{
                Toast.makeText(LocalPhotoVideoActivity.this, platform + " 分享成功啦", Toast.LENGTH_SHORT).show();
            }
        }

        @Override
        public void onError(SHARE_MEDIA platform, Throwable t) {
            Toast.makeText(LocalPhotoVideoActivity.this,platform + " 分享失败啦", Toast.LENGTH_SHORT).show();
        }

        @Override
        public void onCancel(SHARE_MEDIA platform) {
            Toast.makeText(LocalPhotoVideoActivity.this,platform + " 分享取消了", Toast.LENGTH_SHORT).show();
        }
    };
