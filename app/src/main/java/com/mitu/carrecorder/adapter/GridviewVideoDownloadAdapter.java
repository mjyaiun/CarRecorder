...
public class GridviewVideoDownloadAdapter extends BaseAdapter {
    ...
    public GridviewVideoDownloadAdapter(Context mContext, ArrayList<FileEntity> videoList, GridView mGridView) {
        super();
