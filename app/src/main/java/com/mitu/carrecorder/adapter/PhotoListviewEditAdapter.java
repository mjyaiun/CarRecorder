 ...
 * 2016/6/20 0020
 */
public class PhotoListviewEditAdapter extends BaseAdapter {
    ...
    public PhotoListviewEditAdapter(Context cx, Map<String,ArrayList<FileEntity>> mPhotoList, ArrayList<String> dateList) {
        this.mContext = cx;
//		this.ImageArrs = arr;
...
//
                GridviewPhotoEditAdapter gridViewAdapter = new GridviewPhotoEditAdapter(mContext,
                ...
                gridViewAdapter.setOnItemClickListener(new GridviewPhotoEditAdapter.OnItemClickListener() {
                    @Override
