...
public class VideoListviewAdapter extends BaseAdapter {
    ...
    public VideoListviewAdapter(Context cx, Map<String,ArrayList<FileEntity>> mVideoList,ArrayList<String> dateList) {
        this.mContext = cx;
...
//
                GridviewVideoNormalAdapter gridViewAdapter = new GridviewVideoNormalAdapter(mContext,
