 ...
 * 2016/6/20 0020
 */
public class VideoListviewEditAdapter extends BaseAdapter {
    ...
    public VideoListviewEditAdapter(Context cx, Map<String,ArrayList<FileEntity>> mVideoList, ArrayList<String> dateList) {
        this.mContext = cx;
...
//
                GridviewVideoEditAdapter gridViewAdapter = new GridviewVideoEditAdapter(mContext,
                ...
                gridViewAdapter.setOnItemClickListener(new GridviewVideoEditAdapter.OnItemClickListener(){
                    @Override
